...
def main():
    ...
    pdf.set_font("Helvetica", "", 11)
    pdf.multi_cell(0, 6,
        "On the Import Products page, you can upload your updated Excel file:"
    )
    pdf.ln(3)
    ...
    notes = [
        ("File Format", "Use the Excel file exported from our Pricing Automation tool. "
         "It's already formatted for SiteGiant import."),
        ("SKU Matching", "SiteGiant uses SKU to match products. Make sure your SKUs "
         "in the import file match your existing products."),
        ("Price Column", "The 'Selling Price' column contains your updated prices."),
        ("Review Before Confirm", "SiteGiant will show you a preview of changes. "
         "Review carefully before confirming the import."),
        ("Backup First", "Consider exporting your current prices before importing "
