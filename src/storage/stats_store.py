...
class StatsStore:
    ...
    def record_run(
        ...
        logger.info(f"Recorded processing run: {products_processed} processed, {products_updated} updated")
        return run
    ...
    def get_dashboard_stats(self) -> DashboardStats:
        ...
        if today_runs:
            ...
            stats.avg_change_pct = round(sum(avg_changes) / len(avg_changes), 1) if avg_changes else 0.0
